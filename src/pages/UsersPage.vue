  ...
  <q-page class="q-pa-md">
    ...
    <q-dialog v-model="openForm">
      <q-card style="min-width: 400px">
        <q-card-section class="text-h6">{{ form.id ? 'Edit User' : 'New User' }}</q-card-section>

        <q-card-section>
          <q-input v-model="form.fullName" label="Nome Completo" dense autofocus />
          <q-input v-model="form.email" label="Email" dense type="email" class="q-mt-sm" />
          <q-input v-model="form.password" label="Senha" dense type="password" class="q-mt-sm" />
        </q-card-section>
